...
description: "서로 완전히 다른 20가지 디자인 스타일로 발표 덱을 만드는 Copilot Cowork 스킬. 사용자가
  ...
  번호만 바꾸면 완전히 다른 룩으로 생성된다. 다크/라이트 다양하게 구성. 회사·행사에 맞게 커스터마이즈 가능."
cowork:
  category: writing
  icon: SlideText
---
...
> 회사·행사 브랜드에 맞게 바꾸고 싶다면: *"이 스킬에서 design 03을 우리 회사 톤(예: 그린 계열, 로고는 첨부)으로
> 바꿔줘"* 처럼 요청하면 수정된 버전을 만들 수 있습니다.
