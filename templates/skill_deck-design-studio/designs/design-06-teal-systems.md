...
description: "발표 덱 디자인 #06 — Teal Systems. 타이틀(표지)부터 본문까지 이 스타일의 팔레트·폰트·모티프·레이아웃을 정확히 따른다. 사용자가 'design 06으로', 'Teal Systems로'처럼 지정하면 이 디자인으로 덱을 만든다. 라이트 — 밝은 배경 기반."
---
